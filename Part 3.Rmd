...
There is no significant difference between male and female median salary in post doc employment witin each field of study [PVALUE]
...
A comparison of median salary for the non post doc employment group demonstrated a significant difference [PVALUE..] in male vs. female median salary within each discipline group. 
...
pd_graph <- ggplot(pd_data, aes(x = field, y = value))+
  ...
  scale_fill_manual(values = c("plum4", "slategray3"),
                    name = "Group",
                    labels = c("Male Post Doc", "Female Post Doc"
                    ))+
...
emp_graph <- ggplot(emp_data, aes(x = field, y = value))+
  ...
  scale_fill_manual(values = c("plum4", "slategray3"),
                    name = "Group",
                    labels = c("Male Non Post Doc", "Female Non Post Doc"))+
  theme_classic()+
  scale_y_continuous(expand = c(0,0),
                     limits = c(0,125000),

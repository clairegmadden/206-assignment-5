...
#What about chi-square tests? Not sure exactly what the input proportion table would look like- maybe proportion of each field per year, and then see if year has a significant influence on it? - Bridget
